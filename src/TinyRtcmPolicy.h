...
// =============================================================================
// CAP-POLICY — stock Hub filter predicates (STUB)
...
// Current behavior: functions exist for linkage/docs; return values are
// conservative placeholders until CAP-POLICY is marked implemented.
// =============================================================================
...
// STUB STATUS: usable heuristic; not yet covered by self-test goldens (REQ-POL-*).
